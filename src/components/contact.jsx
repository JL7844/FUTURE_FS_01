    ...
    <section className='section1' id='#contact'>
        <div className='container1 lg:grid lg:grid-cols-2 lg:items-stretch'>
            <div className='mb-12 lg:mb-0 lg:flex lg:flex-col'>
                ...
                <p className='text-zinc-400 mt-3 mb-8 max-w-[70ch] lg:max-w-[50ch]'>
                    Reach out today to discuss your project needs and start collaborating on something amazing!
                </p>
                <div className='flex items-center gap-2 mt-auto'>
                    {socialLinks.map(({href, icon}, key) =>(<a key={key}
                    href={href}
                    target='_blank'
            ...
            <form 
                action="https://getform.io/f/azygvekb"
                method="POST"
                className='xl:pl-10 2xl:pl-20'>
                    <div className='md:grid md:items-center md:grid-cols-2 md:gap-2'>
                        <div className='mb-4'>
                            ...
                            <input type="text" name="name" id="name" className='text-field' autoComplete='name' required placeholder='Yoseph Legesse'/>
                        </div>
                        <div className=''>
                            <label 
                            htmlFor="email"
                            ...
                            <input type="email" name="email" id="email" className='text-field' autoComplete='email' required placeholder='jossylegesse27@gmail.com'/>
                        </div>
                    </div>
                    <div className="mb-4">
